	...
	<script>
		function check(){
			...
			if(document.regForm.username.value == ''){
				...
				return;
			}else if(navigator.userAgent.match(/(iPhone|iPad|Android|Windows Phone)/i)) {
		...
		//모바일 시 버튼 숨기기
	if (navigator.userAgent.match(/(iPhone|iPad|Android|Windows Phone)/i)) {
    
	var joinBtn = document.querySelector('input[value="회원가입"]');
    var idFindBtn = document.querySelector('input[value="ID 찾기"]');
    var pwFindBtn = document.querySelector('input[value="pw 찾기"]');
    var loginBtn = document.querySelector('input[value="로그인"]');
    joinBtn.style.display = "none";
    idFindBtn.style.display = "none";
    pwFindBtn.style.display = "none";
